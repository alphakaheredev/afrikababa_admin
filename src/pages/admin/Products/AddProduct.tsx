    ...
    <React.Fragment>
      ...
      <form>
        ...
        <FormRow>
          ...
          <FormRightCol>
            <div className="space-y-5">
              <InputFileVideo label="Ajouter une vidéo" id="video" />
            </div>
          </FormRightCol>
        </FormRow>
        <Divider margin="my-5" />
        <FormRow>
          ...
          <FormRightCol>
            <div className="space-y-5">
              <Input label="Groupe" id="groupe" type="text" required />
              <Input label="Catégorie" id="category" type="text" required />
              <Input label="Fabricants" id="manufacturer" type="text" />
            </div>
          </FormRightCol>
        </FormRow>
        <Divider margin="my-5" />
        <FormRow>
          ...
          <FormRightCol>
            <div className="space-y-5">
              ...
              <Input label="Unité" id="nom" type="text" required />
              <div>
        ...
        <FormRow>
          ...
          <FormRightCol>
            <div className="space-y-5">
              <Input label="Prix" id="price" type="text" required />
              <Input label="Quantité" id="quantity" type="text" required />
              <Input label="Largeur" id="largeur" type="text" />
              <Input label="Longueur" id="longueur" type="text" />
              <Input label="Hauteur" id="hauteur" type="text" />
            </div>
          </FormRightCol>
        </FormRow>
