			...
			<form>
				<FormRow>
					<FormLeftCol>
						<LabelWithDescription
							label="Logo"
							description="Téléchargez ici le logo de votre fournisseur. Les dimensions doivent être de 160 x 160 px."
						/>
					</FormLeftCol>
					<FormRightCol>
						<InputFile
				...
				<FormRow>
					<FormLeftCol>
						<LabelWithDescription
							...
							description="Téléchargez l'image de couverture de votre fournisseur/publication à partir d'ici, la dimension doit être de 960 x 340 px."
						/>
					</FormLeftCol>
					<FormRightCol>
						<InputFile
