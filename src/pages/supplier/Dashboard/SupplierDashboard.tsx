...
const SupplierDashboard = () => {
  return (
    <Fragment>
      <div>
        <img src={banner} alt="banner boutique" className="w-full h-full" />
      </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-dark text-lg font-semibold">
              Boutique vente meubles <BsGlobe className="inline ms-3" />
            </h1>
            <div className="text-th-gray font-normal text-sm space-x-4">
              <span className="border-r border-th-gray">
                @meublehome@innovatelq.sn
              </span>
              <span>Ngor Almadies /Dakar/Sénégal</span>
              <span>+221 00 000 01 02</span>
            </div>
          </div>
        </div>
        <Link to={``} className="bg-[#FB8885] text-white p-3">
        ...
        <div className="col-span-4 card-shadow m-1">
          <div className="border-b border-t-th-gray-e6 border-dashed p-3 mb-3">
            <p className="text-th-gray font-normal text-sm">
              Boutique enregistrée depuis le
            </p>
            <p className="text-dark font-semibold text-base">12 Juillet 2024</p>
          </div>
          <div className="p-3 mb-3">
            <p className="text-dark font-semibold text-base">Description</p>
            <p className="text-th-gray font-normal text-sm">
